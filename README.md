...
*   This is a collision-free, cyan-colored digital twin that runs alongside the main robot. It reflects the unperturbed JTC reference trajectory, allowing instant visual verification of tracking error and dynamic deviations.
